...
import {
  TitleWrapper,TitleText,FilterContainer,TopBar,ButtonContainer,FormContainer,TableContainer,StyledTable,
  TableHeader,
  TableRow,
  TableCell,
  CheckboxCell
} from './usuariosStyles'; //estilos 
import Dropdown from "../../components/Dropdown";
import SearchBar from "../../components/SearchBar";
import Button from "../../components/button";
import UserForm from "../../components/userForm"; 
import { Compass, Trash, Edit, Plus, Eye, UserPlus, Pencil, UserMinus } from "lucide-react"; // iconos
import {getEmployees, deleteEmployees, editEmployees, addEmployees, getBranches, getUsers, addUsers, 
  editUsers, deleteUsers} from '../../api/api_Usuarios'; // peticiones a la api 
  ...
  useEffect(() => {
    const cargarEmpleados = async () => {
      try {
        ...
        const sucursalesMap = {}; // tranforma los datos en un objeto para acceder por su id y relaciona el id con su nombre 
